...
def markdown_gen(locale: str):
    content_json = open("..\\data\\content_derivative.json", "r", encoding="utf-8")
    content_data = json.loads(content_json.read())["DERIVATIVE"]
    column_json = open("..\\data\\column_derivative.json", "r", encoding="utf-8")
