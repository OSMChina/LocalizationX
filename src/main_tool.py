...
def markdown_gen(locale: str):
    content_json = open("..\\data\\content_tool.json", "r", encoding="utf-8")
    content_data = json.loads(content_json.read())["TOOL"]
    column_json = open("..\\data\\column_tool.json", "r", encoding="utf-8")
